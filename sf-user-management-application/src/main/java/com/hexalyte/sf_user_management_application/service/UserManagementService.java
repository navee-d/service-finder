...
public interface UserManagementService {
    ...
    void assignClientRolesToGroup(String groupId, List<RoleRepresentation> rolesToAdd);

    void unassignRealmRolesFromGroup(String groupId, List<RoleRepresentation> rolesToRemove);

    void unassignClientRolesFromGroup(String groupId, List<RoleRepresentation> rolesToRemove);
